...
dot7gFX | Palette fade-out effect in form of a dot command with arguments (simple to call from NextBASIC code)
FailedHdmiCopperFix | failed attempt to fix HDMI timings on core 3.1.5 by copper code
